...
const portfolioData: PortfolioData = {
  name: "エンジニア 太郎",
  title: "ソフトウェアエンジニア",
  heroDescription: "モダンなウェブアプリケーションとクラウドソリューションを構築しています",
  ...
  about: {
    ...
    description: `
      ...
      3年以上の実務経験を持ち、React、Node.js、クラウドアーキテクチャなどの最新技術を活用して、
  ...
  skills: [
    {
      ...
      technologies: ["React", "Vue.js", "JavaScript", "TypeScript", "HTML/CSS", "Tailwind CSS", "Responsive Design"]
    },
    {
      category: "バックエンド",
      icon: <FaNodeJs className="text-4xl text-green-600" />,
      technologies: ["Node.js", "Express", "Python", "Django", "REST API", "GraphQL"]
    },
    {
      category: "データベース",
      icon: <FaDatabase className="text-4xl text-yellow-500" />,
      technologies: ["MongoDB", "PostgreSQL", "MySQL", "Redis", "Prisma", "Sequelize"]
    },
    {
      category: "クラウド & DevOps",
      icon: <FaCloud className="text-4xl text-blue-400" />,
      technologies: ["AWS", "Docker", "CI/CD", "GitHub Actions", "Serverless", "Terraform"]
    },
    {
      category: "開発ツール",
      icon: <FaTools className="text-4xl text-gray-700" />,
      technologies: ["Git", "Webpack", "Vite", "Jest", "VS Code", "Postman"]
    },
    {
      category: "モバイル",
